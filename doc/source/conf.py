...
# documentation src, use os.path.abspath to make it absolute, like shown here.
...
.. |leaddev| replace:: {leaddev}
.. |leaddevmail| replace:: {leaddevmail}
.. |project| replace:: {project}
"""

html_context = {
    'teaser_text': f"We are happy to announce Version {version} of {project}!"
}
...
texinfo_documents = [
  ('index', project, f'{project} Documentation',
   leaddev, project, 'One line description of project.',
   'Miscellaneous'),
]

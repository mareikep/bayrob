...
from calo.application.hypothesis_robot import Hypothesis_Robot, Hypothesis_Robot_FW, Hypothesis_Robot_BW
...
class FWAStar(AStar):
    """Forward-implementation of the A* algorithm in the context of the CALO system.
    """
    ...
    def generate_candidatesteps(self, node, query) -> List[Step]:
        ...
        :param node: the calo hypothesis so far (current node)
...
class BWAStar(AStar):
    """Backward-implementation of the A* algorithm in the context of the CALO system.
    """
    def __init__(self, start, goal, models=None, **kwargs):
        self.models = models
        goal_ = tovariablemapping(goal, models)

...
from bayrob.core.hypothesis import Hypothesis
from jpt.base.intervals import ContinuousSet

from bayrob.utils.p2l import pnt2line
from jpt.variables import VariableMap


class Hypothesis_Robot(Hypothesis):
    """Implementation of Node class for A* algorithm in the context of the BayRoB system.
